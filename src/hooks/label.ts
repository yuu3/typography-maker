...
export const useLabel = () => {
  ...
  const onChangeLabel = (value: string, id: string, target: "fontSize" | "fontWeight" | "lineHeight" | "letterSpacing") => {
  ...
  const addLabel = () => {
    const id = generateId()
    const newLabel = { id, fontSize: 16, fontWeight: 400, lineHeight: 1.5, letterSpacing: 0 }
